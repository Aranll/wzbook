...
var APPID = 'wx85204a5c6dc5ccc8';
var SECRET = 'ba121ea1d6225bcc61af2c9418512ef7';
//上传个人头像到七牛云服务器
var qiniu = require('qiniu');
var QINIU_BUCKET = 'wzbook';//上传空间名
qiniu.conf.ACCESS_KEY = 'H5vRIHVm1hUYT3YOR_SLHXisUKC5MTBcjD8Ex6WR';
qiniu.conf.SECRET_KEY = 'g04W_HBQJnWAuXyh97LIBebp_nPcVmkodHsrrDay';
//aranl,不确定如何修改
qiniu.conf.SCHEME = 'https';
qiniu.conf.UP_HTTPS_HOST = 'https://up.qbox.me';
...
//获取openid
  Myappuser.getOpenId = function(wxcode,cb){
    var qsdata = {
      grant_type: 'authorization_code',
      appid: APPID,
      secret: SECRET,
